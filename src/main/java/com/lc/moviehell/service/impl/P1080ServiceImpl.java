 ...
 */
@Service("p1080Service")
public class P1080ServiceImpl implements IP1080Service {
    private static final Logger logger = LoggerFactory.getLogger(P1080ServiceImpl.class);
